...
var TodoWhere = struct {
	...
	ID:     whereHelpernull_Int64{field: "\"todos\".\"id\""},
...
var (
	...
	todoColumnsWithoutDefault = []string{}
	todoColumnsWithDefault    = []string{"id", "text", "done", "user_id"}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"todos\"", updateOnConflict, ret, update, conflict, insert)
