...
var (
	userAllColumns            = []string{"id", "email", "password_hash", "username", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "email", "password_hash", "username", "created_at", "updated_at"}
